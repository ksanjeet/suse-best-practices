...
image::SAPHanaSR-ScaleOut-MultiTarget-HA.svg[scaledwidth="100%"]
...
image::SAPHanaSR-ScaleOut-MultiTarget-Arch1.svg[scaledwidth="100%"]
...
image::SAPHanaSR-ScaleOut-MultiTarget-HARA.svg[scaledwidth="100%"]
...
Stack: corosync
Current DC: {hanamm} (version 1.1.16-4.8-77ea74d) - partition with quorum
Last updated: Mon July 25 16:55:04 2025
Last change: Mon July 25 16:53:58 2025 by root via crm_attribute on {hanaso2}
...
stonith-sbd     (stonith:external/sbd): Started {hanamm}
rsc_ip_{SID}_HDB{Inst}        (ocf::heartbeat:IPaddr2):       Started {hanaso0}
